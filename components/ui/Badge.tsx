...
const tones = {
  const toneStyles = {
    red: "bg-[#F8E6E3] text-[#AB1604] dark:bg-red-600/30 dark:text-red-200",
  ...
  red: {
    ...
    light: "bg-red-600/20 text-slate-900 ring-red-500/20",
  },
  blue: {
...
const Badge: React.FC<BadgeProps> = ({ mode, tone = "slate", children }) => (
  <span
    className={`inline-flex items-center gap-1 rounded-full px-2.5 py-1 text-xs ring-1 ${tones[tone][mode]}`}
  >
